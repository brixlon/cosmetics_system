defmodule CosmeticsSystem.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    has_one :customer, CosmeticsSystem.CRM.Customer
    has_one :employee, CosmeticsSystem.HR.Employee
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, CosmeticsSystem.Repo)
